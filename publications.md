...
*   A Mayer, H Salopaasi, K Pussi, and RD Diehl, [**A novel method for the extraction of intensity--energy spectra from low-energy electron diffraction patterns**](http://dx.doi.org/10.1016/j.cpc.2012.02.019), *Comput. Phys. Commun.*, 2012, 183(7):1443--1447.

    Source code on [GitHub](https://github.com/andim/easyleed). Documentation of resulting software tool [online](http://andim.github.io/easyleed/).
